...
<BLinePanelTrigger panelId="layer-1" label="Layer 1 Diagram" />
...
<BLineAside>
  The very privacy protections that companies build in the interest of keeping us safe actually reduce the visibility and control we as the owner have.
</BLineAside>
...
<BLinePanelTrigger panelId="layer-2-3" label="Layers 2 & 3" />
...
<BLinePanelTrigger panelId="full-architecture" label="Four-Layer Architecture" />
